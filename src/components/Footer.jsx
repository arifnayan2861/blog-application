      ...
      <div className="px-4 pt-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-4">
        <div className="grid mb-8 lg:grid-cols-6">
          <div className="grid grid-cols-2 gap-5 lg:col-span-4 md:grid-cols-4">
            ...
            <div>
              <p className="text-gray-300 font-medium tracking-wide">Topics</p>
              <ul className="mt-2 space-y-2">
                <li>
                  <a
                    href="/"
            ...
            <div>
              <p className="text-gray-300 font-medium tracking-wide">Banana</p>
              <ul className="mt-2 space-y-2">
                <li>
                  <a
                    href="/"
            ...
            <div>
              <p className="text-gray-300 font-medium tracking-wide">Music</p>
              <ul className="mt-2 space-y-2">
                <li>
                  <a
                    href="/"
          ...
          <div className="md:max-w-md lg:col-span-2 lg:mt-0 mt-5">
            ...
            <p className="mt-4 text-sm text-gray-500">
              ...
              at quisquam voluptatem alias! Ex cum corporis sequi recusandae
              quae dolores accusantium nostrum optio iste, ea, modi quod
              obcaecati omnis fugit.
            </p>
          </div>
        </div>
